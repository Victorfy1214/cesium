...
//   var offsetBufferViewTypedArray = this._offsetBufferViewTypedArray;
...
//   var componentCount = propertyClass.componentCount;
...
//   if (elementType === GltfFeaturePropertyType.STRING) {
...
//       );
//     }
//   } else if (elementType === GltfFeaturePropertyType.SCALAR) {
//     for (i = 0; i < elementCount; ++i) {
//       array[i] = bufferViewTypedArray[i];
//     }
//   } else if (elementType === GltfFeaturePropertyType.ARRAY) {
//     for (i = 0; i < elementCount; ++i) {
//       innerArray = new Array(componentCount);
//       array[i] = innerArray;
//       for (j = 0; j < componentCount; ++j) {
//         innerArray[j] = bufferViewTypedArray[i * componentCount + j];
//       }
//     }
//   } else if (
//     elementType === GltfFeaturePropertyType.VARIABLE_SIZE_ARRAY
//   ) {
//     var componentIndex = 0;
//     for (i = 0; i < elementCount; ++i) {
//       var start = offsetBufferViewTypedArray[i];
//       var end = offsetBufferViewTypedArray[i + 1];
